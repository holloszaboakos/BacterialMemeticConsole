...
value class MeterPerSecond(override val value: Fraction) : PhysicsUnit<MeterPerSecond> {
    ...
    override operator fun times(other: MeterPerSecond) = MeterPerSecond(value * other.value)
    override operator fun times(other: Long) = MeterPerSecond(value * other)
    override operator fun div(other: MeterPerSecond) = MeterPerSecond(value / other.value)
