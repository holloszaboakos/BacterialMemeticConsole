...
class DiversityByMatrixDistanceFromBest<S : ISpecimenRepresentation<C>, C : PhysicsUnit<C>> : Diversity<S, C>() {
    ...
    private fun <S : ISpecimenRepresentation<C>, C : PhysicsUnit<C>> preceditionMatrixWithDistance(
        specimen: S
    ): Array<IntArray> {
